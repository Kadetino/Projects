...
int main() {
	...
	//unsigned char A[16] = { 2, 2, 4, 4, 6, 6, 8, 128, 7, 8, 10, 10, 129, 11, 12, 12 }; // Количество пар: 3
	//unsigned char A[16] = { 1, 1, 2, 2, 5, 5, 7, 7, 128, 128, 77, 77, 98, 98, 56, 56 }; // Количество пар: 2
	/*
	...
	*/
	...
	__asm {
		;// Инициализация
		mov cx, 4; // Задать cx на 4 итерации
	...
	LOOPSTART: mov bl, [esi]; // очередной старший байт из А в регистр bl
		inc esi; // Получить адрес байта 2
		inc esi; // Получить адрес байта 3
		inc esi; // Получить адрес младшего байта 4
		...
		inc esi; // Перейти к адресу байта 2
		inc esi; // Перейти к адресу байта 3
		inc esi; // Перейти к адресу младшего байта 4
	...
	NEXTELEMENT: inc esi; // увеличение адреса массива А на ...
		inc esi; // увеличение адреса массива А на ...
		inc esi; // увеличение адреса массива А на ...
		inc esi; // увеличение адреса массива А на 4
